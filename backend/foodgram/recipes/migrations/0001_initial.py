# Generated by Django 3.2.16 on 2023-04-06 18:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Sorry, but you cannot cook anything in less then a minute!'), django.core.validators.MaxValueValidator(10080, message='We are interested in recipes with less then onewhole week of cooking time.')], verbose_name='Время приготовления')),
                ...
                ('ingredients', models.ManyToManyField(through='recipes.RecipeIngredients', to='recipes.Ingredients', verbose_name='Ingredients')),
